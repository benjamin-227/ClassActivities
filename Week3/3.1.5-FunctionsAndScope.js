...
// child childScope, parent variable: I am in the parent's scope
// child childScope, child variable, I am in the child's scope
// parent scope parent variable: i am in the parents scope
// parents scop child variable: undefined
