...
const cities = data.map(person => {
  return person.address.city;
});
console.log(cities);
// create an array of latitude and longitude coordinate pairs
const latAndLongArray = data.map(person => {
  return person.address.geo;
});
console.log(latAndLongArray);
// create an array of strings that combine the company's catchPhrase and bs
const catchBs = data.map(person => {
  return person.company.catchPhrase + person.company.bs;
});
console.log(catchBs);
