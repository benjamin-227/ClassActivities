...
const tasksToDo = data.filter(chore => {
  return chore.completed === false;
});
// console.log(tasksToDo);
// filter for user 6's tasks
const user6 = data.filter(chore => chore.userId === 6);
// console.log(user6);
// filter for tasks with a title less than 24 characters long
const shortTitle = data.filter(chore => {
  return chore.title.length < 24;
});
// console.log(shortTitle);
//I filtered for titles less than 24 and then created a new array of just the titles
const justTheTitle = shortTitle.map(chore => {
  return chore.title;
});
// console.log(justTheTitle);

const includesIpsam = data.filter(data => {
  return data.title.includes("ipsam");
});
console.log(includesIpsam);
